...
# TODO Uncomment actions before pushing to ec2 instance
...
def test_1_selenium_custom_view_search_page(confluence_webdriver, confluence_datasets, confluence_screen_shots):
    extension_ui.view_search_page(confluence_webdriver, confluence_datasets)


def test_1_selenium_custom_view_space_settings(confluence_webdriver, confluence_datasets, confluence_screen_shots):
    extension_ui.view_space_settings(confluence_webdriver, confluence_datasets)
