...
def test_1_selenium_custom_view_detection_page(confluence_webdriver, confluence_datasets, confluence_screen_shots):
    extension_ui.view_detection_page(confluence_webdriver, confluence_datasets)


def test_1_selenium_custom_view_automation_page(confluence_webdriver, confluence_datasets, confluence_screen_shots):
    extension_ui.view_automation_page(confluence_webdriver, confluence_datasets)


def test_1_selenium_custom_view_log_page(confluence_webdriver, confluence_datasets, confluence_screen_shots):
    extension_ui.view_log_page(confluence_webdriver, confluence_datasets)
